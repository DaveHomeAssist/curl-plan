...
|---|---|---|---|
| P0 Honest release baseline | None | Local checkpoint passed; commit pending | Non-mutating seed, full verifier exits, browser harness, Worker lock/build, account tests, negative gate |
| P1 Classic workflows and recovery | P0 | Ready after P0 commit | Browser CRUD/reload/failure/recovery plus modal, contrast, focus, calendar, and support-policy evidence |
