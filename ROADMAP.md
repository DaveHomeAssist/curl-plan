...
| P4 Identity and abuse boundaries | P3 | Local implementation committed at `77908ad`; phase exit open | Token, password, authorization, blocking, CORS, recovery, and abuse checks are green locally; controlled TLS staging proof is still required |
