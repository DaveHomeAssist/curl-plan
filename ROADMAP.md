...
| P4 Identity and abuse boundaries | P3 | Closed through controlled cloud staging: D1 migration at `313fce6`, Clerk issuer deployment at `2cdf3e2`, and positive identity/lifecycle proof from tooling at `e2ce7a9` | Isolated D1 migration, Worker TLS/health, positive and negative Clerk auth/JWKS, exact CORS, and authenticated merge/idempotency/export/restore/delete lifecycle are green |
| P5 Native and release readiness | P3 and P4 | Unlocked; not started | One native state owner, archive resources, device accessibility/performance, and final release record |
