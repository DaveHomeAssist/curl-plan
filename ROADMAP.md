...
| P4 Identity and abuse boundaries | P3 | Local implementation committed at `77908ad`; staging gates at `0e8e6d4`; isolated cloud config at `313fce6`; phase exit open | Cloud D1 migration, Worker TLS/health, negative auth, and exact CORS are green; dedicated Clerk positive JWT/JWKS and authenticated lifecycle proof remain required |
