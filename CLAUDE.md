...
[2026-08-26] [CurlPlan] [fix] Audit remediation on main: atomic revision-checked Worker sync writes + strict JWT claim validation (247a10b)
[2026-08-26] [CurlPlan] [fix] Audit remediation on feat/account-foundation-credential-auth: classic saveIce reads a declared ice entry (H-01, 9ed08ce); account backend serializes saves, revokes blocked admin authority, async scrypt with rate limit and account quota (H-02/H-04/H-13, 75f191b); SW cache pruning scoped per worker lineage with a guarded root shell entry (H-08/H-09, 2b1e0da); classic dialog semantics with inert overlays, valid shadow tokens, dark-mode surface contrast, keyboard-operable root controls (H-10/H-11/H-12/M-01, cc974ea)
